  ...
  home-manager.users.eimmer = {
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        exec = let 
          bar-wlrs = "${lib.getExe inputs.bar-wlrs.packages.${system}.default} --updated-last ${builtins.readFile ../../updated_last}";
        in [ "${lib.getExe pkgs.killall} .bar-wlrs-wrapped bar-wlrs; ${bar-wlrs}" ];
